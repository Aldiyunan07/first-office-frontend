...
export default function BookOffice() {
    ...
    if (!office) {
        return <p>Office tidak ditemukan</p>;
    }
    ...
    return (
        <>
            <div id="Banner" className="relative w-full h-[240px] flex items-center shrink-0 overflow-hidden -mb-[50px]">
                ...
                <img src={`${baseURL}/${office.thumbnail}`} className="absolute w-full h-full object-cover object-top" alt="" />
            </div>
            <form onSubmit={handleSubmit} className="relative flex justify-center max-w-[1130px] mx-auto gap-[30px] mb-20 z-20">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center rounded-full border border-[#000929] px-5 gap-[10px] transition-all duration-300 focus-within:ring-2 focus-within:ring-[#0D903A]">
                                ...
                                <input onChange={handleChange} type="text" name="name" id="name" value={formData.name} className="appearance-none outline-none w-full py-3 font-semibold placeholder:font-normal placeholder:text-[#000929]" placeholder="Write your complete name" />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center rounded-full border border-[#000929] px-5 gap-[10px] transition-all duration-300 focus-within:ring-2 focus-within:ring-[#0D903A]">
                                ...
                                <input onChange={handleChange} type="tel" name="phone_number" id="phone_number" value={formData.phone_number} className="appearance-none outline-none w-full py-3 font-semibold placeholder:font-normal placeholder:text-[#000929]" placeholder="Write your valid number" />
                                {formErrors.find((error) => error.path.includes('phone_number')) && <p className="text-red-500">phone_number is required</p>}
                            </div>
                        </div>
                        <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col shrink-0 w-[400px] h-fit rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    ...
                    <hr className="border-[#F6F5FD]" />
                    <button type='submit' disabled={loading} className="flex items-center justify-center w-full rounded-full p-[16px_26px] gap-3 bg-[#0D903A] font-bold text-[#F7F7FD]">
                        <span> {loading ? 'Loading ...' : "I've Already Paid"}</span>
                    </button>
                </div>
            </form>
        </>
